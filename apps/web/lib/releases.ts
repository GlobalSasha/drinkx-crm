...
// появился новый экран, добавьте <Section> в /guide + пункт в TOC.
// У /guide две версии — менеджера и руководителя; кладите раздел в ту, чья
// это работа, и в её TOC (константа TOC в app/(app)/guide/page.tsx).
// Поле `anchor` связывает запись с разделом руководства (#id на /guide).
// Если раздел лежит в версии другой роли, добавьте его id в MANAGER_ONLY /
// HEAD_ONLY там же — иначе ссылка из «Что нового» проваливается в пустоту.
//
