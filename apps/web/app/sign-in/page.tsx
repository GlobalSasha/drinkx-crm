  ...
  return (
    <div className="relative max-w-md w-full bg-white border border-brand-border rounded-card p-12 shadow-soft">
      ...
      <button
        ...
        disabled={loading}
        className="w-full py-2.5 px-4 rounded-pill border border-brand-border bg-transparent text-sm text-brand-muted hover:text-brand-primary hover:border-brand-border transition-all duration-300 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
      >
