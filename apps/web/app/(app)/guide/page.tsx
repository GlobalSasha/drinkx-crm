...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Отдельного списка компаний в навигации нет — карточка компании открывается из карточки лида кликом по названию. Это намеренно: менеджер работает со сделками (лидами), а не с юр.лицами.",
  },
  {
