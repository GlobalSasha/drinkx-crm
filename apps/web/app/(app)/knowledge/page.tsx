    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <div className="bg-white border border-black/5 rounded-2xl shadow-soft p-10">
        ...
        <p className="text-sm text-muted-2 leading-relaxed mb-5">
          ...
          предложений. Чак будет ссылаться на материалы прямо из ленты лида, а менеджеры
        ...
        <div className="text-xs text-muted-2 border-t border-black/5 pt-4">
          Пока материалы готовятся, Чак уже умеет отвечать на вопросы по продукту и
          возражениям прямо в ленте лида — задайте @Чак вопрос в любой карточке.
        </div>
      </div>
    </div>
  );
