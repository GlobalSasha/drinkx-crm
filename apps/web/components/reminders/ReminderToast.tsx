...
export function ReminderToast({ task, onOpen, onSnooze, onClose }: Props) {
  ...
  return (
    <div
      role="alert"
      className="pointer-events-auto w-[330px] max-w-full rounded-2xl border border-white/50 bg-white/75 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.18)] p-4 animate-[fadeInUp_0.28s_ease-out]"
    >
