...
CONTACT_EXTRACTION_SYSTEM = """Ты извлекаешь имена людей из текста.
...
- Приоритет должностям: категорийный менеджер, директор по закупкам,
  операционный/коммерческий директор, руководитель направления."""
